...
cookbook 'yum', "~> 3.13.0"
cookbook "apt", "~> 2.4.0"
cookbook 'opsworks_sidekiq', git: 'git://github.com/omarramos/opsworks_sidekiq.git'
cookbook 'opsworks_rails_secrets', git: 'git://github.com/hyperventures/opsworks_rails_secrets.git'
